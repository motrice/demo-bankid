ARG BINARY_NAME_DEFAULT=demobankid

FROM clux/muslrust:1.39.0-nightly as builder
...
RUN set -x && cargo build --target x86_64-unknown-linux-musl --features json --release
